          ...
          <Col span={8}>
            <div className="total">
              ...
              <Row className="row-phone">
                <Col span={8}>
                  Phone<span className="span-colon">:</span>
                </Col>
                <Col span={16}>
                  <p>
                    {orderDetails.address ? orderDetails.address.phone : null}
                  </p>
                </Col>
              </Row>
              <Row className="row-shipping1">
                <Col span={8}>
                  Shipping <span className="span-colon">:</span>
                </Col>
                <Col span={16}>
                  <p>
                  ...
                  <p>
                    {orderDetails.address ? orderDetails.address.city : null}
                  </p>
                </Col>
              </Row>
